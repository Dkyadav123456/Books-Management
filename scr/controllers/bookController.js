      ...
      for (let i = 0; i < subcategory.length; i++) {
        ...
        if (!isValid(element)) {
          return res.status(400).send({
            status: false,
            message:
              'subcategory is (required field) format like: ["Fiction","Classic"]',
          });
        }
      }
    }
